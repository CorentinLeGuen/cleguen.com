...
const { pending: pending_last, error: error_last, data: data_last } = useFetch('/draw/last', { server: false });
const { pending: pending_stats, error: error_stats, data: data_stats } = useFetch('/draw/stats', { server: false });
