...
<template>
    <form action="https://formspree.io/f/xpwpypbj" method="POST" class="text-gray-600 flex flex-col space-y-2 border border-gray-200 bg-white/30 backdrop-blur-md rounded shadow px-4 py-2 my-4">
