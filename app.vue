<template>
    <div>
        <NuxtLayout>
            <nav class="border-gray-200 bg-gray-50 shadow">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <button data-collapse-toggle="navbar-solid-bg" type="button"
                        class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-0"
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                        <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
                            <li>
                                <NuxtLink class="block py-2 px-3 md:p-0 text-gray-500 rounded md:hover:bg-transparent md:border-0 hover:text-gray-800" to="/posts/lotto649">
                                    {{ $t('posts.lotto649.title') }}
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink class="block py-2 px-3 md:p-0 text-gray-500 rounded md:hover:bg-transparent md:border-0 hover:text-gray-800" to="/posts/git-notes">
                                    Git Notes
                                </NuxtLink>
                            </li>
                        </ul>
                        <hr class="h-px my-4 md:hidden" />
                    </div>
            ...
            <div id="alert-c" class="fixed bottom-0 right-0 flex items-center p-4 border rounded-lg bg-gray-50 shadow m-2 mb-8" role="alert">
                🍪
                <span class="sr-only">Info</span>
                <div class="ms-3 px-4 text-sm text-center font-medium text-gray-800">
                    {{  $t('cookie_policy') }}
                </div>
                <button type="button" class="ms-auto mx-1.5 -my-1.5 bg-gray-50 text-gray-500 rounded-lg focus:ring-0 p-1.5 hover:bg-gray-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white" data-dismiss-target="#alert-c" aria-label="Close">
